...
export interface SimulationShader extends ProgramWrapper {
  uniformLocations: {
    u_particleTexture: WebGLUniformLocation
    u_spawnTexture: WebGLUniformLocation
    u_resolution: WebGLUniformLocation
    u_deltaTime: WebGLUniformLocation
    u_time: WebGLUniformLocation
    u_persistence: WebGLUniformLocation
  }
}
